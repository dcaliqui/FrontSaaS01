		...
		<>
			<div className="bg-white ">
				<div className="container m-auto  flex justify-center items-center h-screen">
					<section className="  flex  w-7xl h-283.25 ">
						<div className="side w-[50%] h-full flex justify-between flex-col  p-5">
							...
							<div className="flex justify-around text-white">
								...
								<p className="tracking-wide uppercase">Desde 2026</p>
								<p className="tracking-wide uppercase">Primeira comunidade</p>
								<p>A GRAÇA ABUNDA</p>
							</div>
						</div>
						<div className="w-full h-full flex flex-col justify-center items-center gradientes ">
							<div className="w-94 h-181 flex flex-col ">
								...
								<button className="p-4 bg-white text-black flex gap-2 items-center justify-center rounded-2xl mb-10">
								...
								<form action="" className="flex flex-col">
									...
									<button className="bg-[#002045] flex justify-center items-center text-white h-14 rounded-2xl mb-10">
										<p>ENTRAR</p>
										<ArrowRight size={24}/>
									</button>
									<div className="w-full h-px bg-gray-400 mb-10"></div>
									<p className="text-[#43474E] text-center">Primeira vez aqui ?<span className="text-[#002045] hover:cursor-pointer">Criar conta.</span> </p>
								</form>
							</div>
						</div>
					</section>
