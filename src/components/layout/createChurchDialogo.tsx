...
export function DialogDemo({
	...
	return (
		<Dialog open={open} onOpenChange={handleOpenChange}>
			<DialogTrigger
				asChild
				className="bg-[#FFDEA5] dark:bg-[#1E3A8A] dark:text-white text-[#261900] w-56 rounded-2xl px-6 py-4 mt-8 hover:cursor-pointer"
			>
			...
			<DialogContent className="w-full sm:max-w-2xl md:max-w-3xl lg:max-w-3xl max-h-[90vh] p-6 overflow-auto">
				...
				<DialogFooter className="w-full">
					...
					<Button
						type="button"
						className="bg-[#1E3A8A] dark:text-white"
						disabled={submitting}
						onClick={(e) => {
							e.preventDefault()
							e.stopPropagation()
