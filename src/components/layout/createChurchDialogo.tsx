...
import OrganizatioSelect from "@/components/layout/OrganizatioSelect"
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <form onSubmit={handleSubmit}>
        ...
        <DialogContent className="w-full sm:max-w-2xl md:max-w-3xl lg:max-w-3xl max-h-[90vh] p-6 overflow-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-170">
            ...
            <div className="flex flex-col">
              ...
              {/* enabled={open} garante que o fetch só ocorre quando o diálogo está aberto */}
              <OrganizatioSelect id="organization" name="organization" enabled={open} />
            </div>
